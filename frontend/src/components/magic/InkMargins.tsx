...
// Mobile: just a whisper of ink at the screen edges — behind the hero, never the form.
const MOBILE_SCATTER: Speck[] = [
  { side: "left", top: "4%", off: "-4%", size: 92, rot: -14, op: 0.12, src: INK[1], delay: 0 },
  { side: "right", top: "7%", off: "-5%", size: 84, rot: 12, op: 0.12, src: INK[3], delay: 0.5 },
  { side: "left", top: "46%", off: "-6%", size: 76, rot: 8, op: 0.08, src: INK[0], delay: 1 },
];
...
/** Decorative real-tattoo ink in the page margins (full set on desktop, a faint
 *  whisper at the edges on mobile). */
