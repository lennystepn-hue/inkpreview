/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 7486988528234efd354a070fba203ec6)
// Runtime types generated with workerd@1.20260921.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	JOBS: Queue;
	OPENAI_IMAGE_MODEL: string;
	OPENAI_COMPOSITE_MODEL: string;
	OPENAI_IMAGE_SIZE: string;
	OPENAI_IMAGE_QUALITY: string;
	OPENAI_COMPOSITE_QUALITY: string;
	OPENAI_TEXT_MODEL: string;
	CANONICAL_HOST: string;
	CORS_ORIGINS: string;
	ANON_RATE_LIMIT: string;
	RATE_LIMIT_WINDOW_S: string;
	GUEST_GENERATION_LIMIT: string;
	FREE_MONTHLY_GENERATION_LIMIT: string;
	PROMO_UNLIMITED: string;
	BODY_PHOTO_TTL_HOURS: string;
	PREVIEW_TTL_HOURS: string;
	MAX_UPLOAD_MB: string;
	FREE_EXPORT_MAX_PX: string;
	...
	DB: DurableObjectNamespace<import("./src/index").Database>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_IMAGE_MODEL" | "OPENAI_COMPOSITE_MODEL" | "OPENAI_IMAGE_SIZE" | "OPENAI_IMAGE_QUALITY" | "OPENAI_COMPOSITE_QUALITY" | "OPENAI_TEXT_MODEL" | "CANONICAL_HOST" | "CORS_ORIGINS" | "ANON_RATE_LIMIT" | "RATE_LIMIT_WINDOW_S" | "GUEST_GENERATION_LIMIT" | "FREE_MONTHLY_GENERATION_LIMIT" | "PROMO_UNLIMITED" | "BODY_PHOTO_TTL_HOURS" | "PREVIEW_TTL_HOURS" | "MAX_UPLOAD_MB" | "FREE_EXPORT_MAX_PX" | "STRIPE_AUTOMATIC_TAX" | "APP_ENV" | "IMAGE_ENGINE" | "DB_JURISDICTION" | "SESSION_SECRET" | "FRONTEND_BASE_URL" | "GOOGLE_REDIRECT_URI">> {}
}
